...
public class Meds extends Controller{
    ...
    public Result createMed(Long id) {
        ...
        DateTimeFormatter hourFormat = DateTimeFormat.forPattern("hh:mm aa");
        ...
        models.Meds nMed = models.Meds.createNewMed(med_name,nDose,startDate,timeDaily,hFreq,nWeek,nMonth,nDay,pillCount,device);
